    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-header bg-dark text-white">
          <h4 class="modal-title">Modification d'une nature de dépense</h4>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>
      <form action="{{route('nature_depense.update', $item->id)}}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
          <!-- Modal body -->
          <div class="modal-body">
            <div class="form-group row">
              ...
              <input type="text" class="form-control" id="designation" placeholder="Saisir le code ici" name="designation" autocomplete="off" value="{{$item->designation}}">
