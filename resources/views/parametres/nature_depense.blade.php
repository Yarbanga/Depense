...
<div class="row">
    <div class="col-12 col-lg-12">
        <div class="card">
            <form class="form-horizontal" id="agent_form" action="{{route('nature_depense.save')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <fieldset>
            ...
            @if ($natureDepenses->isNotEmpty())
                ...
                <table class="table table-striped mb-2">
                    ...
                    <tbody>
                        @foreach ($natureDepenses as $item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    @include('parametres.modals.type_depense_modal')
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
